...
transformer.save("androidres/values/strings2.xml", { valueCol: "DEFAULT", format: "android" });
transformer.save("androidres/values-fr/strings2.xml", { valueCol: "ES", format: "android" });
